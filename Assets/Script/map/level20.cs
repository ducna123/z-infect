...
public class level20 : MonoBehaviour {
    ...
    void Start () {
        ...
        myBody7 = barb.GetComponent<Rigidbody2D>();
    }
        ...
        if(Time.timeScale != 0 && win == false)
        {
            ...
            if (d == 0)
            {
                ...
                else if (Input.GetMouseButtonUp(0))
                {
                    ...
                    {
                        if (myBody.velocity.y == 0 && myBody1.velocity.y == 0 && myBody2.velocity.y == 0 && myBody3.velocity.y == 0 && myBody4.velocity.y == 0 && myBody5.velocity.y == 0 && myBody6.velocity.y == 0 && myBody7.velocity.y == 0)
                        {
                            if (mousePos1.y < 0)
                            {
    ...
    void _check()
    {
        for (int i = 0; i < 4; i++)
        {
            if (lv20[i].gameObject.tag == "zombie") dem++;
        }
        Debug.Log(dem);
        if (dem == 4)
        {
